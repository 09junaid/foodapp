...
import { signup } from "@/modules/auth/authSlice";
...
export default function SignUpPage() {
  ...
  const onSubmit: SubmitHandler<InputDataType> = async (data) => {
    try {
      const result = await dispatch(signup(data)); // dispatch signup thunk
          ...
          <div className="bg-white shadow-lg rounded-xl p-6 sm:p-8 w-full max-w-xl min-h-[500px]">
            ...
            >
              ...
              <div className="relative">
                ...
                >
                  {showPassword ? <FaRegEyeSlash className="text-[#8EC63F]" /> : <FaRegEye className="text-[#8EC63F]"/>}
                </div>
              ...
              <button
                ...
                className="w-full bg-[#8EC63F] mt-6 cursor-pointer text-white py-3 rounded font-semibold hover:bg-[#6e9b2f] transition duration-300
